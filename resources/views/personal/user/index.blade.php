    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-2 col-md-6 mb-4">
                <a href="{{route('personal.user.create')}}" class="btn btn-block btn-primary">Добавить</a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            <a href="{{ route('personal.user.show', $user->id) }}" class="btn btn-link p-1">
                                                <i class="far fa-eye"></i>
                                            </a>
                                            <a href="{{ route('personal.user.edit', $user->id) }}" class="btn btn-link text-success p-1">
