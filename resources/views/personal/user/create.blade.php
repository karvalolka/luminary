    ...
    <div class="container-fluid">
                ...
                <td style="text-align: right;">
                    <nav aria-label="Breadcrumb">
                        <ol style="display: inline; padding: 0; margin: 0; list-style: none;">
                            ...
                            <li style="display: inline; margin-left: 10px;"><a href="{{route('personal.user.index')}}">Пользователи</a>
                            </li>
        ...
        <div class="row">
            <div>
                ...
                <form action="{{route('personal.user.store')}}" method="POST" class="col-xl-12 col-md-6 mb-4">
                    @csrf
