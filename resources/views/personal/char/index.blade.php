    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-2 col-md-6 mb-4">
                <a href="{{route('personal.char.create')}}" class="btn btn-block btn-primary">Добавить</a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            ...
                                            <a href="{{ route('personal.char.edit', $char->id) }}" class="btn btn-link text-success p-1">
