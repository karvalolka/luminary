                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                            ...
                                            <p>{{$char->race->name}}</br></p>
                                            <p>{{$char->grade->name}}</br></p>
                                            <p>{{$char->fraction->name}}</br></p>
                                    ...
                                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                        <div class="text-center">
                                            <a class="btn btn-outline-dark mt-auto" href="{{ auth()->user()->isAdmin() ? route('admin.char.show', $char->id) : route('personal.char.show', $char->id) }}"> <!-- Временное решение -->
                                                Выбрать
                                            </a>
                                        </div>
                                    </div>
